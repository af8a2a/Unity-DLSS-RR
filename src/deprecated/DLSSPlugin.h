...
//
// //------------------------------------------------------------------------------
// // SECTION 5: Low-Level NGX Parameter API (for advanced use)
// //------------------------------------------------------------------------------
// // These functions provide direct access to NGX SDK parameter interface,
// // similar to UnityDenoiserPlugin. Use these for maximum flexibility when
// // the high-level API doesn't meet your needs.
// //------------------------------------------------------------------------------
//
...
// typedef struct DLSSCreateFeatureEventData
// {
//     int32_t handle;
//     DLSSNGXFeature feature;
//     void* parameters;   // NVSDK_NGX_Parameter*
// } DLSSCreateFeatureEventData;
//
// /// Parameters for evaluate feature render event
// typedef struct DLSSEvaluateFeatureEventData
// {
//     int32_t handle;
//     void* parameters;   // NVSDK_NGX_Parameter*
// } DLSSEvaluateFeatureEventData;
//
// /// Parameters for destroy feature render event
// typedef struct DLSSDestroyFeatureEventData
// {
//     int32_t handle;
// } DLSSDestroyFeatureEventData;
//
// //--- Low-Level Parameter Management ---
//
// /// Allocate NGX parameters structure.
// /// @param outParams Receives pointer to allocated parameters.
// /// @return DLSS result code.
// DLSS_PLUGIN_API DLSSResult DLSS_PLUGIN_CALL DLSS_AllocateParameters(void** outParams);
//
// /// Get capability parameters from NGX.
// /// @param outParams Receives pointer to capability parameters.
// /// @return DLSS result code.
